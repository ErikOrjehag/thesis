...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{depthmaps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{3drender}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{3dseq}
